...
const DashboardHome = () => {
    ...
    return (
        <div className="px-6 md:px-10 py-10">
            ...
            <div className="border border-violet-400/30 bg-violet-400/5 rounded-lg p-5 mb-8">
                <div className="flex items-center justify-between mb-3">
                    <div><p className="text-xs uppercase tracking-wide text-violet-200">Study coach</p><h2 className="text-richblack-5 font-semibold">Keep your next session focused</h2></div>
                    <Link to="/Dashboard/StudyPlan" className="text-xs text-yellow-50 hover:underline">Open plan →</Link>
                </div>
                <div className="grid sm:grid-cols-3 gap-3">
                    <Link to="/Dashboard/Review" className="border border-border-soft rounded-md p-3 hover:bg-surface-hover"><p className="text-sm text-richblack-100">Review due cards</p><p className="text-xs text-richblack-400 mt-1">Keep spaced repetition on schedule</p></Link>
                    <Link to="/Dashboard/Exams" className="border border-border-soft rounded-md p-3 hover:bg-surface-hover"><p className="text-sm text-richblack-100">Prepare for an exam</p><p className="text-xs text-richblack-400 mt-1">Plan sessions and export your calendar</p></Link>
                    <Link to="/Dashboard/StudyRooms" className="border border-border-soft rounded-md p-3 hover:bg-surface-hover"><p className="text-sm text-richblack-100">Study together</p><p className="text-xs text-richblack-400 mt-1">Share tasks and progress with your group</p></Link>
                </div>
            </div>
