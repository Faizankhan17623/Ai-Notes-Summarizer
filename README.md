...
- **Auth** — signup with OTP email verification, JWT (httpOnly cookie + bearer), forgot/reset password, optional 2FA (TOTP authenticator app) on login, OAuth social login (Google/GitHub, whichever are configured), and a 2-day account delete/recover buffer
