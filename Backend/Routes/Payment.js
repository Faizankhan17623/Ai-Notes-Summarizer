...
const { paymentLimiter } = require('../Middlewares/RateLimit.js')
...
route.post('/payment/order', paymentLimiter, doubleCsrfProtection, createOrderRules, validate, Auth, blockIfBanned, createOrder)
