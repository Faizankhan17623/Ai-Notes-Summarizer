// pure Express app setup sir — no app.listen(), no cron scheduling, no DB connect. Split out
// of index.js so tests (Backend/__tests__/) can require() a fully-wired app instance without
// triggering scheduleWeeklyDigest()/schedulePlanExpiryWarnings()/backfillProMaxCapNotice() or
// binding a real port. index.js is now the thin runtime entry point that does those things.
